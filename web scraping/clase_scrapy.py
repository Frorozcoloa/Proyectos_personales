...
class Spider12(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # Listado de notas
        notas = response.xpath('//ul[@class="article-li4st"]//li//a/@href').getall()
        for nota in notas:
    ...
    def parse_nota(self, response):
        ...
        # imagen = response.xpath('//div[@class="article-main-media-image"]/img').getall()
